...
<nav id="navbar">
    <div class="navbar-inner">
        ...
        <?php
        if (isset($_SESSION["userID"])) {
            $SQL = "SELECT `profilepicture` FROM `haldenvg_norskeMemes`.users WHERE `username` = '$userID'";
            ...
            if (!$result) {
                ...
                <div class="navbar-right flexbox-right">
                    <a class="profile-picture">
                        <img alt="" src="data:image/png;base64,'.base64_encode($profilePicture).'" width="100%" height="100%">
                    </a>
                </div>';
            }
        }
...
<main class="flexbox">
    <?php
    if (isset($_SESSION["userID"])) {
        echo " <p>Hei, $userID! Velkommen tilbake. Du er nå innlogget. Er ikke dette gøy?";
    }
    else {
        echo "<p>Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.Dette er en test.</p>";
    }
    ?>
</main>
</body>
