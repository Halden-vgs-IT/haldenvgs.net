...
<head>
    ...
    <title>Halden VGS - Prosjekter</title>
    ...
    <main id="main">
        ...
        <header id="header" class="flexbox">
            ...
            <div class="header-content flexbox">
                ...
                <h1 class="header-title"><span>Prosj</span>ekter</h1>

            </div>

            <div class="header-overlay"></div>

            <img class="header-img" src="https://images.unsplash.com/photo-1555099962-4199c345e5dd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80" alt="">
        ...
        <div id="page" class="flexbox-col">
            ...
            <div class="top-bar flexbox-col">
                ...
                <div class="flexbox-col-left">
                    ...
                    <h1 class="top-bar-title">Prosjekter</h1>

                    <p class="top-bar-text">Dette er Halden videregående skole sin server for elevenes egne nettsider.</p>

                </div>

                <div class="btn-wrapper">

                    <a href="info.php"><button class="button3 btn-primary3"><i class="uil uil-map-marker-info"></i> Info<div class="btn-secondary3"></div></button></a>
