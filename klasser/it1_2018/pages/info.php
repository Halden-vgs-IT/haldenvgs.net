    ...
    <main id="main">
        ...
        <header id="header" class="flexbox">
            ...
            <div class="header-content flexbox">
                ...
                <h1 class="header-title"><span>In</span>fo</h1>
        ...
        <div id="page" class="flexbox-col">
            ...
            <div class="top-bar flexbox-col">
                ...
                <div class="flexbox-col-left">
                    ...
                    <h1 class="top-bar-title">Info</h1>
                ...
                <div class="btn-wrapper">
                    ...
                    <a href="prosjekter.php"><button class="button3 btn-primary3"><i class="uil uil-folder-open"></i> Prosjekter<div class="btn-secondary3"></div></button></a>
